// Wed, 13 Dec 2023 15:28:01 GMT
import{html as a,LitElement as A}from"./lit-all.min.js";import{unsafeHTML as v}from"./lit-all.min.js";var u=class{constructor(t,e){this.key=Symbol("match-media-key"),this.matches=!1,this.host=t,this.host.addController(this),this.media=window.matchMedia(e),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),t.addController(this)}hostConnected(){var t;(t=this.media)==null||t.addEventListener("change",this.onChange)}hostDisconnected(){var t;(t=this.media)==null||t.removeEventListener("change",this.onChange)}onChange(t){this.matches!==t.matches&&(this.matches=t.matches,this.host.requestUpdate(this.key,!this.matches))}};var f="hashchange";function C(r=window.location.hash){let t=[],e=r.replace(/^#/,"").split("&");for(let i of e){let[n,o=""]=i.split("=");n&&t.push([n,decodeURIComponent(o)])}return Object.fromEntries(t)}function p(r){let t=new URLSearchParams(window.location.hash.slice(1));Object.entries(r).forEach(([e,i])=>{i?t.set(e,i):t.delete(e)}),t.sort(),window.location.hash=decodeURIComponent(t.toString())}function g(r){let t=e=>{let i=C(window.location.hash);r(i)};return t(),window.addEventListener(f,t),()=>{window.removeEventListener(f,t)}}var x=(r,t={})=>{requestAnimationFrame(()=>{r.querySelectorAll("span[data-placeholder]").forEach(e=>{let{placeholder:i}=e.dataset;e.innerText=t[i]??""})})};var y="(max-width: 1200px)",T="(min-width: 768px)",b="(min-width: 1200px)";import{css as E,unsafeCSS as S}from"./lit-all.min.js";var w=E`
    #header,
    #resultText,
    #footer {
        grid-column: 1 / -1;
