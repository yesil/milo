...
:root {
    ...
    /* special offer */
    --consonant-merch-card-special-offer-max-width: 378px;
    --consonant-merch-card-special-offer-full-width: 100%;
...
merch-card[variant="special-offers"] {
    max-width: var(--consonant-merch-card-special-offer-max-width);
}
...
merch-card[type="super-wide"] {
    width: 1200px;
    text-align: center;
    max-width: 1200px;
}

merch-card[variant="special-offers"][type="wide"] {
    min-width: 100%;
}
