...
`,Ra=()=>{let e=[V`
    ...
    `}get cardImage(){return g` <div class="image">
        ...
        ${this.badge}
          ...
          >`:"";return g`<footer>${t}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,r=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||r===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-r-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}};x(Ht,"styleMap",{});var k=Ht;function Te(e,t={},r){let n=document.createElement(e);r instanceof HTMLElement?n.appendChild(r):n.innerHTML=r;for(let[i,o]of Object.entries(t))n.setAttribute(i,o);return n}function Ua(){return window.matchMedia("(max-width: 767px)").matches}function Da(){return window.matchMedia("(max-width: 1024px)").matches}function Ma(e=1e3){return new Promise(t=>setTimeout(t,e))}var Ga="merch-offer-select:ready",Ha="merch-card:ready",za="merch-card:action-menu-toggle";var wi="merch-storage:change",Pi="merch-quantity-selector:change";var Fa=`
:root {
...
merch-card[variant="catalog"] .payment-details {
  ...
  font-weight: 400;
  line-height: var(--consonant-merch-card-body-line-height);
}`;var st=class extends k{constructor(r){super(r);x(this,"toggleActionMenu",r=>{let n=r?.type==="mouseleave"?!0:void 0,i=this.card.shadowRoot.querySelector('slot[name="action-menu-content"]');i&&(n||this.card.dispatchEvent(new CustomEvent(za,{bubbles:!0,composed:!0,detail:{card:this.card.name,type:"action-menu"}})),i.classList.toggle("hidden",n))})}renderLayout(){return g` <div class="body">
    ...
    <slot></slot>`}getGlobalCSS(){return Fa}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenu)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenu)}};x(st,"variantStyle",V`
...
`;var ct=class extends k{constructor(t){super(t)}getGlobalCSS(){return ja}renderLayout(){return g` <div class="body">
        <slot name="icons"></slot> ${this.badge}
        <slot name="heading-xs"></slot>
        <slot name="heading-m"></slot>
...
`;var Fr=class extends k{constructor(t){super(t)}getGlobalCSS(){return Ka}renderLayout(){return g`${this.cardImage}
    <div class="body">
...
`;var jr=class extends k{constructor(t){super(t)}getGlobalCSS(){return Ba}renderLayout(){return g` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var Tl=32,ht,lt=class extends k{constructor(r){super(r);ce(this,ht);x(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);x(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?g`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){Ua()?this.removeEmptyRows():(await Promise.all(this.card.prices.map(r=>r.onceSettled())),this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};ht=new WeakMap,x(lt,"variantStyle",V`
...
`;var ut=class extends k{constructor(t){super(t)}getGlobalCSS(){return Xa}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?g`<label id="stock-checkbox">
        ...
        ${this.secureLabelFooter}`}};x(ut,"variantStyle",V`
    :host([variant='plans']) {
      min-height: 348px;
    }
...
`;var zt=class extends k{constructor(t){super(t)}getGlobalCSS(){return Wa}renderLayout(){return g` ${this.badge}
      <div class="body">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
          <slot name="body-xxs"></slot>
...
`;var dt=class extends k{constructor(t){super(t)}getGlobalCSS(){return qa}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return g` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
        ${this.promoBottom?"":g`<slot name="promo-text"></slot><slot name="callout-content"></slot>`}
    ...
    <hr />
    ${this.secureLabelFooter}`}};x(dt,"variantStyle",V`
...
`;var mt=class extends k{constructor(t){super(t)}getGlobalCSS(){return Za}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return g`${this.cardImage}
          <div class="body">
...
`;var pt=class extends k{constructor(t){super(t)}getGlobalCSS(){return Ja}renderLayout(){return g`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
      ...
      <footer><slot name="footer"></slot></footer>`}};x(pt,"variantStyle",V`
    :host([variant='twp']) {
      padding: 4px 10px 5px 10px;
    }
    .twp-badge {
...
`;var ft=class extends k{getGlobalCSS(){return Qa}renderLayout(){return g` <div class="content">
          <slot name="icons"></slot> ${this.badge}
          <slot name="body-s"></slot>
          <slot name="footer"></slot>
        </div>
        <slot name="image"></slot>
        <slot></slot>`}};x(ft,"variantStyle",V`
  ...
  `);var Ci=(e,t=!1)=>{switch(e.variant){case"catalog":return new st(e);case"ccd-action":return new ct(e);case"image":return new Fr(e);case"inline-heading":return new jr(e);case"mini-compare-chart":return new lt(e);case"plans":return new ut(e);case"product":return new zt(e);case"segment":return new dt(e);case"special-offers":return new mt(e);case"twp":return new pt(e);case"ccd-slice":return new ft(e);default:return t?void 0:new zt(e)}},es=()=>{let e=[];return e.push(st.variantStyle),e.push(ct.variantStyle),e.push(lt.variantStyle),e.push(ut.variantStyle),e.push(dt.variantStyle),e.push(mt.variantStyle),e.push(pt.variantStyle),e.push(ft.variantStyle),e};var ts=document.createElement("style");ts.innerHTML=`
:root {
