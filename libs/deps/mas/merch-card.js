...
`,A=()=>{let p=[C`
    ...
    `),p};var[R,O,M,L,N,ne]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var H=document.createElement("style");H.innerHTML=`
:root {
