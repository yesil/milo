import{html as a,LitElement as V,nothing as W}from"/libs/deps/lit-all.min.js";import{LitElement as F,html as $,css as j}from"/libs/deps/lit-all.min.js";var d=class extends F{static properties={size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0}};constructor(){super(),this.size="m",this.alt=""}render(){let{href:e}=this;return e?$`<a href="${e}">
    ...
    `};customElements.define("merch-icon",d);import{css as C,unsafeCSS as u}from"/libs/deps/lit-all.min.js";var x="(max-width: 767px)",y="(max-width: 1199px)",i="(min-width: 768px)",c="(min-width: 1200px)",s="(min-width: 1600px)";var _=C`
    :host {
        position: relative;
        display: flex;
