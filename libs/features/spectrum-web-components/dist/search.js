...
import { html as p, nothing as m } from "/libs/features/spectrum-web-components/dist/base.js";
import { property as l, query as h } from "/libs/features/spectrum-web-components/dist/base.js";
import { ifDefined as u } from "/libs/features/spectrum-web-components/dist/base.js";
import { Textfield as b } from "/libs/features/spectrum-web-components/dist/textfield.js";
...
`;
var search_css_default = e;

// node_modules/@spectrum-web-components/search/src/Search.js
var d = Object.defineProperty;
var c = Object.getOwnPropertyDescriptor;
var r2 = (o, s, e2, t) => {
  for (var i = t > 1 ? void 0 : t ? c(s, e2) : s, n = o.length - 1, a2; n >= 0; n--)
    (a2 = o[n]) && (i = (t ? a2(s, e2, i) : a2(i)) || i);
  return t && i && d(s, e2, i), i;
};
var v = (o) => o.stopPropagation();
var Search = class extends b {
  constructor() {
    super(...arguments);
    this.action = "";
    this.label = "Search";
  ...
  handleSubmit(e2) {
    this.dispatchEvent(new Event("submit", { cancelable: true, bubbles: true })) || e2.preventDefault();
  }
  handleKeydown(e2) {
    const { code: t } = e2;
    t === "Escape" && this.holdValueOnEscape || !this.value || t !== "Escape" || this.reset();
  }
  async reset() {
  ...
  firstUpdated(e2) {
    super.firstUpdated(e2), this.hasAttribute("holdValueOnEscape") || this.inputElement.setAttribute("type", "search");
  }
  willUpdate() {
    this.multiline = false;
  }
};
r2([l()], Search.prototype, "action", 2), r2([l()], Search.prototype, "label", 2), r2([l()], Search.prototype, "method", 2), r2([l()], Search.prototype, "placeholder", 2), r2([l({ type: Boolean })], Search.prototype, "holdValueOnEscape", 2), r2([h("#form")], Search.prototype, "form", 2);
