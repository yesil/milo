...
import { html as a, nothing as m } from "/libs/features/spectrum-web-components/dist/base.js";
import { property as l, query as b } from "/libs/features/spectrum-web-components/dist/base.js";
import { ifDefined as u } from "/libs/features/spectrum-web-components/dist/base.js";
import { Textfield as h } from "/libs/features/spectrum-web-components/dist/textfield.js";
...
var r2 = (o, s, e2, t) => {
  for (var i = t > 1 ? void 0 : t ? c(s, e2) : s, n = o.length - 1, p; n >= 0; n--)
    (p = o[n]) && (i = (t ? p(s, e2, i) : p(i)) || i);
  return t && i && d(s, e2, i), i;
};
var v = (o) => o.stopPropagation();
var Search = class extends h {
  constructor() {
    super(...arguments);
    this.action = "";
    this.label = "Search";
  ...
  handleKeydown(e2) {
    const { code: t } = e2;
    !this.value || t !== "Escape" || this.reset();
  }
  async reset() {
  ...
  firstUpdated(e2) {
    super.firstUpdated(e2), this.inputElement.setAttribute("type", "search");
  }
  willUpdate() {
    this.multiline = false;
  }
};
r2([l()], Search.prototype, "action", 2), r2([l()], Search.prototype, "label", 2), r2([l()], Search.prototype, "method", 2), r2([l()], Search.prototype, "placeholder", 2), r2([b("#form")], Search.prototype, "form", 2);
