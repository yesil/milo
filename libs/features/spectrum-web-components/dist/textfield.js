...
import { ifDefined as l, live as y } from "/libs/features/spectrum-web-components/dist/base.js";
...
// node_modules/@spectrum-web-components/textfield/src/Textfield.js
import E from "/libs/features/spectrum-web-components/dist/icons/checkmark.js";
var c = Object.defineProperty;
var m = Object.getOwnPropertyDescriptor;
var t2 = (p, a, e2, n) => {
  for (var r = n > 1 ? void 0 : n ? m(a, e2) : a, u = p.length - 1, h; u >= 0; u--)
    (h = p[u]) && (r = (n ? h(a, e2, r) : h(r)) || r);
  return n && r && c(a, e2, r), r;
};
var S = ["text", "url", "tel", "email", "password"];
var TextfieldBase = class extends g(v(f, { noDefaultSize: true })) {
  ...
  static get styles() {
    return [textfield_css_default, E];
  }
  set type(e2) {
    const n = this._type;
    this._type = e2, this.requestUpdate("type", n);
  }
  get type() {
    var e2;
    return (e2 = S.find((n) => n === this._type)) != null ? e2 : "text";
  }
  set value(e2) {
    if (e2 === this.value)
      return;
    const n = this._value;
    this._value = e2, this.requestUpdate("value", n);
  }
  get value() {
    return this._value;
  }
  ...
  setSelectionRange(e2, n, r = "none") {
    this.inputElement.setSelectionRange(e2, n, r);
  }
  select() {
