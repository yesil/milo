...
import { html as n, SpectrumElement as d } from "/libs/features/spectrum-web-components/dist/base.js";
...
import "/libs/features/spectrum-web-components/dist/icons-workflow.js";
import "/libs/features/spectrum-web-components/dist/icons-workflow.js";
import { FocusVisiblePolyfillMixin as h } from "/libs/features/spectrum-web-components/dist/shared.js";
...
`;
var toast_css_default = o;

// node_modules/@spectrum-web-components/toast/src/Toast.js
var c = Object.defineProperty;
var p = Object.getOwnPropertyDescriptor;
var r = (a, i, t3, o2) => {
  for (var e = o2 > 1 ? void 0 : o2 ? p(i, t3) : i, s = a.length - 1, u; s >= 0; s--)
    (u = a[s]) && (e = (o2 ? u(i, t3, e) : u(e)) || e);
  return o2 && e && c(i, t3, e), e;
};
var toastVariants = ["negative", "positive", "info", "error", "warning"];
var Toast = class extends h(d) {
  constructor() {
    super(...arguments);
    this.open = false;
    this._timeout = null;
    ...
    this.nextCount = -1;
    this.doCountdown = (t3) => {
      this.countdownStart || (this.countdownStart = performance.now()), t3 - this.countdownStart > this._timeout ? (this.shouldClose(), this.countdownStart = 0) : this.countdown();
    };
    this.countdown = () => {
  ...
  set timeout(t3) {
    const e = typeof t3 !== null && t3 > 0 ? Math.max(6e3, t3) : null, s = this.timeout;
    e && this.countdownStart && (this.countdownStart = performance.now()), this._timeout = e, this.requestUpdate("timeout", s);
  }
  get timeout() {
  ...
  set variant(t3) {
    if (t3 === this.variant)
      return;
    const o2 = this.variant;
    toastVariants.includes(t3) ? (this.setAttribute("variant", t3), this._variant = t3) : (this.removeAttribute("variant"), this._variant = ""), this.requestUpdate("variant", o2);
  }
  get variant() {
  ...
  updated(t3) {
    super.updated(t3), t3.has("open") && (this.open ? this.timeout && this.startCountdown() : this.timeout && this.stopCountdown()), t3.has("timeout") && (this.timeout !== null && this.open ? this.startCountdown() : this.stopCountdown());
  }
};
r([l({ type: Boolean, reflect: true })], Toast.prototype, "open", 2), r([l({ type: Number })], Toast.prototype, "timeout", 1), r([l({ type: String })], Toast.prototype, "variant", 1);
