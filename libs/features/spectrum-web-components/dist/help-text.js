...
var n = (i3, t3, l2, r) => {
  for (var e2 = r > 1 ? void 0 : r ? u(t3, l2) : t3, a = i3.length - 1, s2; a >= 0; a--)
    (s2 = i3[a]) && (e2 = (r ? s2(t3, l2, e2) : s2(e2)) || e2);
...
import { conditionAttributeWithId as o2 } from "/libs/features/spectrum-web-components/dist/base.js";
var i = class i2 {
  constructor(e2, { mode: n2 } = { mode: "internal" }) {
    this.mode = "internal";
    this.handleSlotchange = ({ target: e3 }) => {
      this.handleHelpText(e3), this.handleNegativeHelpText(e3);
    };
    this.host = e2, this.instanceCount = i2.instanceCount++, this.id = `sp-help-text-${this.instanceCount}`, this.mode = n2;
  }
  get isInternal() {
  ...
  render(e2) {
    return s`
            <div id=${l(this.isInternal ? this.id : void 0)}>
                <slot
                    name=${e2 ? "negative-help-text" : `pass-through-help-text-${this.instanceCount}`}
  ...
  addId() {
    ...
    this.conditionId = o2(this.host, "aria-describedby", e2), this.host.hasAttribute("tabindex") && (this.previousTabindex = parseFloat(this.host.getAttribute("tabindex"))), this.host.tabIndex = 0;
  }
  removeId() {
